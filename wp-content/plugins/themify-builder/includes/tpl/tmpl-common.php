...
<template id="tmpl-builder_column_item">
    ...
    <div class="tb_holder tf_box tf_rel tf_w tf_h"></div>
...
<template id="tmpl-last_row_add_btn">
        ...
        <div id="container" class="tf_overflow tf_rel tf_box tf_w<?php echo $isGsPost?>">
            <a href="javascript:;" class="add_btn tf_textc tf_text_dec">+</a>
        </div>
</template>
<template id="tmpl-last_row_expand">
    <div class="grids tf_opacity tf_hidden" tabindex="-1">
        <?php for($i=1;$i<7;++$i):?>
