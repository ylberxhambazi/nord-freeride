...
if (!class_exists('Themify_Builder')) :
	...
	function register_deprecated_cpt() {
        ...
        public function wp_loaded() {
            ...
            // Hook to frontend
            add_action('wp_head', array($this, 'inline_css'),0);
	...
	public function inline_css(){
		...
		Themify_Builder_Model::loadCssModules('parallax',THEMIFY_BUILDER_CSS_MODULES .'parallax.css',THEMIFY_VERSION,'m'!==$is_parallax?'all':'screen and (min-width:'.$tablet.'px)');
	    }
	    if($is_lax!==false){
