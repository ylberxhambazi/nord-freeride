                            ...
                            try{
                                ...
                                if(found===true){
                                    ...
                                    if(isVisible===true){
                                        ...
                                        await Notification.show('info',f);
                                    }
                                    if(images[i+1]!==und){
                                        try{
                                ...
                                if(isVisible===true && uploadData.skip.size>0){
                                    ...
                                    await Notification.showHide('error',download_fail.replaceAll('%post%',msg),2000);
                                }
                                if(found===true && res.length>0){
                                    delete uploadData.skip;
                                    let r;
                                    if(isVisible===true && upLoadMsg!==''){
                                        let msg=Notification.el.shadowRoot.querySelector('.msg_text');
                                        if(msg){
                                            if(summ>len){
                                                summ=len;
                                            }
                                    ...
                                    if(isVisible===true && result.size>0){
                                        for(let [url,msg] of result){
                                            await Notification.showHide('error',upload_fail.replaceAll('%post%',url).replaceAll('%msg%',msg),2000);
                                        }
                                    }
                                }
                            }
