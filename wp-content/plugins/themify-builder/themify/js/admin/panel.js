                    ...
                    if(entries[i].isIntersecting===true){
                        ...
                        try{
                            if(el.classList.contains('ajax_select')){
                                ...
                                let {ThemifyCodeMiror}=await Themify.importJs(Themify.url+'js/admin/modules/codemirror/codemirror'),
                                obj=new ThemifyCodeMiror(el,el.dataset.codeditor);
                                await obj.run();
                            }
                        }
                        catch(e){
            ...
            const f=doc.createDocumentFragment(),
                ...
                btn.tfOn('click',async e=>{
                    ...
                    if(!bt.disabled){
                        ...
                        Notification.show('info',bt.dataset.clearing);
                        try{
                            ...
                            await Notification.showHide('done',bt.dataset.done,1500);
                        }
                        catch(e){
                            const msg=e.data?e.data:e;
                            await Notification.showHide('error',msg);
                        }
                        sp.textContent=defaultText;
                        bt.disabled=false;
                    }
