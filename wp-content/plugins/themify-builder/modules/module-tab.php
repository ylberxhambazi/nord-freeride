...
class TB_Tab_Module extends Themify_Builder_Component_Module {
	...
	$title = array(
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_image('.ui .tab-nav li', 'background_color_title', 'bg_c', 'bg_i', 'background-color')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_image('.ui .tab-nav li', 'b_c_t', 'bg_c', 'bg_i', 'background-color', 'h')
			)
		    )
		))
	    )),
		...
		self::get_tab(array(
			...
			'options' => array(
			    ...
			    self::get_image('.ui .tab-nav li.current', 'active_background_color_title', __('Background Active', 'themify'), 'bg_i', 'background-color'),
			...
			'options' => array(
			    ...
			    self::get_image('.ui .tab-nav li.current:hover', 'active_hover_background_color_title', __('Background Active', 'themify'), 'bg_i', 'background-color'),
