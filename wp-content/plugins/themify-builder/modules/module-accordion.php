...
class TB_Accordion_Module extends Themify_Builder_Component_Module {
	...
	$accordion_title = array(
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_image(array(' .ui.module-accordion .accordion-title', ' .ui.module-accordion li'), 'background_color_title', 'bg_c', 'bg_i', 'background-color')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_image(array(' .ui.module-accordion .accordion-title', ' .ui.module-accordion li'), 'b_c_t', 'bg_c', 'bg_i', 'background-color',  'h')
			)
		    )
		))
	    )),
