	...
	$text_before = array(
		...
		self::get_tab(array(
			...
			'options' => array(
			    ...
			    self::get_line_height(' .tb_star_text_b', 'l_h_t_b', 'h'),
			    self::get_letter_spacing(' .tb_star_text_b', 'l_s_t_b', 'h'),
			    self::get_text_transform(' .tb_star_text_b', 't_t_t_b', 'h'),
	    ...
	    self::get_expand('w', array(
		    self::get_tab(array(
			    ...
			    'h' => array(
				    'options' => array(
					    self::get_width(' .tb_star_text_b', 'w_t_b', 'h')
				    )
			    )
		    ))
	    )),
	...
	$text_after = array(
		...
		self::get_tab(array(
			...
			'options' => array(
			    ...
			    self::get_line_height(' .tb_star_text_a', 'l_h_t_a', 'h'),
			    self::get_letter_spacing(' .tb_star_text_a', 'l_s_t_a', 'h'),
			    self::get_text_transform(' .tb_star_text_a', 't_t_t_a', 'h'),
	    ...
	    self::get_expand('w', array(
		    self::get_tab(array(
			    ...
			    'h' => array(
				    'options' => array(
					    self::get_width(' .tb_star_text_a', 'w_t_a', 'h')
				    )
			    )
		    ))
	    )),
