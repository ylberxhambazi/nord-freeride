				...
				self::get_tab( array(
					...
					'h' => array(
						'options' => array(
							...
							self::get_line_height( ' > ul', 'lh_toc_li_cn', 'h' ),
							self::get_letter_spacing( ' > ul', 'l_s_toc_li_cn', 'h' ),
							self::get_text_align( ' > ul', 't_a_toc_li_cn', 'h' ),
							self::get_text_transform( ' > ul', 't_t_toc_li_cn', 'h' ),
		...
		$list_items = array(
			...
			self::get_expand( 'f', array(
				self::get_tab( array(
					...
					'h' => array(
						'options' => array(
							self::get_text_transform( ' li', 't_t_toc_li', 'h' ),
		...
		$child_list_container = array(
			...
			self::get_expand( 'f', array(
				self::get_tab( array(
					...
					'h' => array(
						'options' => array(
							self::get_text_transform( ' ul ul', 't_t_toc_cli_cntr', 'h' ),
		...
		$child_list_items = array(
			...
			self::get_expand( 'f', array(
				self::get_tab( array(
					...
					'h' => array(
						'options' => array(
							self::get_text_transform( ' ul ul li', 't_t_toc_cli', 'h' ),
