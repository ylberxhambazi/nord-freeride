                ...
                return new Promise((resolve,reject)=>{
                    ...
                    api.LiteLightBox.confirm(opt).then(async answer => {
                        ...
                        try{
                            ...
                            if(file.type==='text/plain' || file.type==='application/json'){
                                ...
                                reader.tfOn('loadend',function(e){
                                    try{
                                        ...
                                        api.Notification.showHide('error',themifyBuilder.i18n.importBuilderNotExist);
                                        reject(e);
                                    }
                                },{passive:true,once:true})
                                .readAsText(file);
                            ...
                            api.Spinner.showLoader('error');
                            if(e.message){
                                api.Notification.showHide('error',e.message);
                            }
                            reject(e);
                        }
                    });
                ...
                const lb=await api.LightBox.open({
                    ...
                    submit = function(e) {
                        ...
                        if(Object.keys(_ajaxData.data).length>0){
                                ...
                                if(answer){
                                    ...
                                    api.LocalFetch(_ajaxData).then(data => {
                                        if (data.builder_data !== undefined) {
                                            ...
                                            api.Spinner.showLoader('error');
                                            api.Notification.showHide('error',themifyBuilder.i18n.postBuilderNotExist);
                                        }
                                    })
                                    .catch(() => {
                                        api.Spinner.showLoader('error');
                            ...
                            api.Notification.showHide('error',themifyBuilder.i18n.importSelectPost);
                        }
                    };
