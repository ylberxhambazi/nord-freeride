    ...
    ThemifyConstructor = {
        ...
        date: {
            ...
            render(data, self) {
                ...
                if (this.loaded === null) {
                    const init = () => {
                        topWindow.Themify.loadCss(themifyBuilder.meta_url + 'css/jquery-ui-timepicker.min');
                        topWindow.Themify.loadJs(themifyBuilder.includes_url + 'js/jquery/ui/datepicker.min',(topWindow.jQuery.fn.datepicker !== und),themify_vars.wp).then(()=>{
                            topWindow.Themify.loadJs(themifyBuilder.meta_url + 'js/jquery-ui-timepicker.min',(topWindow.jQuery.fn.themifyDatetimepicker !== und || topWindow.jQuery.fn.datetimepicker !== und),'1.6.3').then(()=>{
                                this.loaded = true;
