    ...
    api.LayoutPart = class {
            ...
            return new Promise(async(resolve, reject) => {
                ...
                let module = model.el.closest('.active_module'),
                    ...
                    callback = async() => {
                        ...
                        this.el = module;
                        let newBuilder = new api.Builder(builder, self.cache[builderId].builder_data, self.cache[builderId].custom_css);
            ...
            return new Promise((resolve,reject) => {
                const _callback = () => {
                    ...
                    if (this.cssFile) {
                        ...
                        model.trigger('ajax', Object.assign({unsetKey: true}, model.get('mod_settings'))).then(() => {
        ...
        async save() {
			...
			try{
			   ...
			   //     api.Notification.showHide('done', themifyBuilder.i18n.layoutPartSaved);
