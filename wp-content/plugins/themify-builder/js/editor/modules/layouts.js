        ...
        loadLayout(target) {
            ...
            .finally(() => {
                ...
                api.Spinner.showLoader(type).then(() => {
                    ...
                    const data = this.el ? this.el : themifyBuilder.i18n.layoutError;
                    ...
                    api.LightBox.open({
                        ...
                        if(this.el){
                            ...
                            if(!Themify.isTouch){
                                setTimeout(()=>{
                                    this.el.querySelector(this.el.querySelector('.title.current a').getAttribute('href')).tfClass('tb_layout_search')[0].focus();
                                    this.el = null;
                                },125);
                            }
                        }
