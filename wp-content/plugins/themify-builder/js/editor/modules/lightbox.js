    ...
    api.LightBox =  {
        ...
        save() {
            return new Promise((resolve,reject)=>{
                ...
                if(!this.el.classList.contains('tf_hide')){
                    if (model!== null) {
                        if (!api.Forms.isValidate(this.el.querySelector('#tb_options_setting'))) {
                            reject();
                            return false;
                        }
                        ...
                        Themify.trigger('tb_save_lb').then(resolve).catch(reject);
                        return;
                    }
                }
                resolve();
    ...
    api.Forms = {
        ...
        isValidate(form) {
            ...
            if (is_valid === false) {
                ...
                api.Notification.showHide('error',themifyBuilder.i18n.lightBoxRequiredFields);
            }
            return is_valid;
        },
